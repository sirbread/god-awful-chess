...
class Game:
    ...
    def handle_mouse_click(self, pos):
        if self.game_over and hasattr(self, 'restart_button_rect') and self.restart_button_rect.collidepoint(pos):
            self.reset()
            return
    ...
    def draw_game_over(self, screen):
        ...
        button_rect = pygame.Rect(SCREEN_WIDTH // 2 - 50, SCREEN_HEIGHT // 2, 100, 40)
